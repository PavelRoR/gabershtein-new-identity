...
function imToVideo() {
    $('.video-wrapper-revs iframe').each(function () {
        ...
        $(this).parent().html('<img src="' + l + '" alt="Видео отзыв"><div class="play-button"></div>');
    });
    $(".video-wrapper-revs img, .play-button").click(function () {
...
/* Видео */
$(".video-wrapper-revs img, .play-button").click(imToVideo());
/*Конец документа*/
});